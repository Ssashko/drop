...
function toRanges(jsonData) {
    return {
        rightAngle: Range.create(jsonData.rightAngle.l, jsonData.rightAngle.r),
        bottomAngle: Range.create(jsonData.bottomAngle.l, jsonData.bottomAngle.r),
        leftAngle: Range.create(jsonData.leftAngle.l, jsonData.leftAngle.r),
        topAngle: Range.create(jsonData.topAngle.l, jsonData.topAngle.r),
        Yangle: Range.create(jsonData.Yangle.l, jsonData.Yangle.r)
    };
}
