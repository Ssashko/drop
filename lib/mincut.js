class MinimumCircumscribeCut {
    ...
    getCut() {
        return Polygon.create(this.min_quadrangle).getListVertices();
    }
    getRestCut() {
        let q0 = Point.create(this.min_quadrangle[0]);
        let q1 = Point.create(this.min_quadrangle[1]);
        let q2 = Point.create(this.min_quadrangle[2]);
        let q3 = Point.create(this.min_quadrangle[3]);
